...
public class Template4Activity extends BaseActivity {
    ...
    public void initView(@Nullable Bundle savedInstanceState) {
            ...
            XXPermissions.with(this)
                    ...
                    .request(new OnPermissionCallback() {
                        ...
                        public void onGranted(List<String> permissions, boolean all) {
                            ActivityUtils.startActivity(Template4Activity.this, SearchBTActivity.class);
                        }
        ...
        mBinding.tvPrinter1.setOnClickListener(v -> {
            print1(0);
        });
        mBinding.tvPrinter2.setOnClickListener(v -> {
            print2(0);
        });
        mBinding.tvPrinter3.setOnClickListener(v -> {
            print3(0);
        });
        mBinding.tvPrinter4.setOnClickListener(v -> {
            print4(0);
        });
    ...
    private void setBleStatues() {
        ...
        if (isOpened) {
            ...
            mBinding.tvCon.setText("打印未连接-点击去连接");
        }
    }
    ...
    public void print1(int blackNumber) {
        final String title_str = "称     重     单";
        final String no_str = mBinding.etXh.getText().toString().trim();
        final String date_str = mBinding.etDate.getText().toString().trim();
        final String time_str = mBinding.etTime.getText().toString().trim();
    ...
    public void print2(int blackNumber) {
        final String title_str = "称     重     单";
        final String no_str = mBinding.etXh.getText().toString().trim();
        final String date_str = mBinding.etDate.getText().toString().trim();
        final String time_str = mBinding.etTime.getText().toString().trim();
    ...
    public void print3(int blackNumber) {
        final String title_str = "称     重     单";
        final String no_str = mBinding.etXh.getText().toString().trim();
        final String date_str = mBinding.etDate.getText().toString().trim();
        final String time_str = mBinding.etTime.getText().toString().trim();
    ...
    public void print4(int blackNumber) {
        final String title_str = "称     重     单";
        final String no_str = mBinding.etXh.getText().toString().trim();
        final String date_str = mBinding.etDate.getText().toString().trim();
        final String time_str = mBinding.etTime.getText().toString().trim();
