...
import com.taopao.fastprinter.databinding.ActivityTemplate5Binding;
...
public class Template5Activity extends BaseActivity {
    private ActivityTemplate5Binding mBinding;

    @Override
    public ViewBinding obtainViewBinding(@Nullable LayoutInflater layoutInflater) {
        mBinding = ActivityTemplate5Binding.inflate(layoutInflater);
        return mBinding;
    }
            ...
            XXPermissions.with(this)
                    ...
                    .request(new OnPermissionCallback() {
                        ...
                        public void onGranted(List<String> permissions, boolean all) {
                            ActivityUtils.startActivity(Template5Activity.this, SearchBTActivity.class);
                        }
