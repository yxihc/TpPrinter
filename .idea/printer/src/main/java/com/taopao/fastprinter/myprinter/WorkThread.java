package com.taopao.fastprinter.myprinter;
...
import com.taopao.fastprinter.PrinterUtils;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case Global.MSG_WORKTHREAD_HANDLER_CONNECTBT: {
                    ...
                    boolean result = PrinterUtils.getInstance().mBtPrinting.Open(BTAddress);
                    ...
                    MMKV.defaultMMKV().putString("blpaddress", BTAddress);
